object Dependencies {
    ...
    object GoogleMaps {
        const val secretsGradlePlugin = "com.google.android.libraries.mapsplatform.secrets-gradle-plugin:secrets-gradle-plugin:${Versions.googleMapsSecrets}"
        const val runtime = "com.google.android.gms:play-services-maps:${Versions.googleMaps}"
        const val ktx = "com.google.maps.android:maps-ktx:${Versions.googleMapsKtx}"
        const val utils = "com.google.maps.android:maps-utils-ktx:${Versions.googleMapsKtx}"
    }
